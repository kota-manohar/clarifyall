...
/**
 * Parse and normalize extracted tool data from futurepedia
 */
function parsefuturepediaData() {
    console.log('🔧 Parsing and normalizing futurepedia data...');

    if (!fs.existsSync(RAW_DATA_FILE)) {
        throw new Error(`Raw data file not found: ${RAW_DATA_FILE}. Please run scrape-futurepedia.js first.`);
    }
        ...
        try {
            ...
            if (websiteUrl && !websiteUrl.startsWith('http')) {
                if (websiteUrl.startsWith('//')) {
                    ...
                    websiteUrl = 'https://www.futurepedia.io' + websiteUrl;
                } else {
                    websiteUrl = 'https://' + websiteUrl;
                }
            }
            ...
            const parsedTool = {
                name,
                description: description || 'AI tool from futurepedia.io',
                full_description: fullDescription || description || 'AI tool from futurepedia.io',
...
module.exports = parsefuturepediaData;
