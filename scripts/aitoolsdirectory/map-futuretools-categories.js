...
const NEW_CATEGORIES_FILE = path.join(OUTPUT_DIR, 'futuretools-new-categories.json');
...
/**
 * Map FutureTools categories to database categories
 */
function mapFutureToolsCategories() {
    console.log('🗂️  Mapping FutureTools categories...');
    ...
    // For now, we'll create new categories for all FutureTools categories
    ...
    const categorySql = [];
    categorySql.push('-- ============================================');
    categorySql.push('-- INSERT CATEGORIES FROM FUTURETOOLS.IO');
    ...
    // Save category SQL
    const categorySqlFile = path.join(SQL_OUTPUT_DIR, 'insert-futuretools-categories.sql');
...
module.exports = mapFutureToolsCategories;
