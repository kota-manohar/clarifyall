...
function CategoriesPage() {
  ...
  return (
    <div className="categories-page">
      <SEO
        title={`AI Tool Categories - Browse ${categories.length}+ Categories | Clarifyall`}
        description={`Explore ${categories.length}+ categories of AI tools including chatbots, image generation, writing, coding, video editing, marketing, and more. Find the perfect AI tool for your specific needs.`}
